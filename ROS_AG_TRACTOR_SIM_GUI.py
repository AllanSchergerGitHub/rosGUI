...
# this is set up to be used with the ROS Agriculture Tractor Sim
...
title1 = "roslaunch lawn_tractor_sim lawn_tractor_sim.launch"  # title shows on the button - it can be any helpful text
working_directory1 = "--working-directory=/home/allan/tractor_ros_ws"
command1 = "roslaunch lawn_tractor_sim lawn_tractor_sim.launch"  # package and launch_file_name

title2 = "roslaunch rover_gazebo_control start_navsat.launch"  # title shows on the button - it can be any helpful text
working_directory2 = "--working-directory=~/tractor_ros_ws"
